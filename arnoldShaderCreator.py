...
def getDock(name="ShaderManagerDock"):
    ...
    ctrl = cmds.workspaceControl(name, dockToPanel=(panels,'top',0), label="Shader Manager")  # Docks the window in the right at first
...
def deleteDock(name="ShaderManagerDock"):
